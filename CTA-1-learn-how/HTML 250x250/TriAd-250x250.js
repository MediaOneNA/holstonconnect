...
lib.ssMetadata = [
		{name:"TriAd_250x250_atlas_1", frames: [[0,252,188,161],[252,0,181,120],[0,0,250,250],[190,252,235,106],[252,122,54,27]]}
];
...
(lib._1aTheMoreYouFlyTheMoreWeFly = function() {
	this.initialize(ss["TriAd_250x250_atlas_1"]);
	this.gotoAndStop(0);
...
}).prototype = getMCSymbolPrototype(lib.CTA1b, new cjs.Rectangle(0,0,181,120), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib._1aTheMoreYouFlyTheMoreWeFly();

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA1a, new cjs.Rectangle(0,0,188,161), null);
...
if (reversed == null) { reversed = false; }
	...
	// _a_The_More_You_Fly__The_More_We_Fly_
	this.instance_1 = new lib.CTA1a();
	this.instance_1.setTransform(123,121.5,1,1,0,0,0,94,80.5);
	this.instance_1.alpha = 0;
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(3).to({_off:false},0).to({alpha:1},14).wait(72).to({alpha:0},16,cjs.Ease.quartInOut).wait(465));

	// _b_
	this.instance_2 = new lib.CTA1b();
	this.instance_2.setTransform(126.5,117,1,1,0,0,0,90.5,60);
	this.instance_2.alpha = 0;
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(105).to({_off:false},0).to({alpha:1},22,cjs.Ease.quartInOut).wait(443));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(11).to({_off:false},0).to({x:117.5,y:197,alpha:1},30,cjs.Ease.quartInOut).wait(529));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/TriAd_250x250_atlas_1.png", id:"TriAd_250x250_atlas_1"}
	],
	preloads: []
};
