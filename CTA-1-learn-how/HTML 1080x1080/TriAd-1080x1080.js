...
lib.ssMetadata = [
		{name:"TriAd_1080x1080_atlas_1", frames: [[0,0,1080,1080],[1082,603,898,245],[1082,850,464,145],[0,1082,1080,76],[1548,850,209,105],[1082,0,950,601]]}
];
...
}).prototype = getMCSymbolPrototype(lib.CTA1b, new cjs.Rectangle(0,0,464,145), null);
...
}).prototype = getMCSymbolPrototype(lib.CTA1a, new cjs.Rectangle(0,0,898,245), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_4 = new lib.CTA1a();
	this.instance_4.setTransform(538,150.7,1,1,0,0,0,449,122.5);
	this.instance_4.alpha = 0;
	this.instance_4._off = true;

	this.instance_5 = new lib.CTA1aTheMoreYouFlyTheMoreWeFly();
	this.instance_5.setTransform(89,21);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(2).to({_off:false},0).to({y:143.5,alpha:1},31,cjs.Ease.quintInOut).to({_off:true},566).wait(1));

	// CTA_1b_Learn_How
	this.instance_6 = new lib.CTA1b();
	this.instance_6.setTransform(542,272.5,1,1,0,0,0,232,72.5);
	this.instance_6.alpha = 0;
	this.instance_6._off = true;

	this.instance_7 = new lib.CTA1bLearnHow();
	this.instance_7.setTransform(310,200);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_6}]},22).to({state:[{t:this.instance_6}]},23).to({state:[{t:this.instance_7}]},554).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(22).to({_off:false},0).to({alpha:1},23,cjs.Ease.quintInOut).to({_off:true},554).wait(1));
