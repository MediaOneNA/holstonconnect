...
lib.ssMetadata = [
		{name:"TriAd_320x50_atlas_1", frames: [[0,0,320,50],[289,104,178,46],[311,52,173,32],[322,0,61,30],[0,104,287,46],[0,52,309,50]]}
];
...
}).prototype = getMCSymbolPrototype(lib.CTA1b, new cjs.Rectangle(0,0,173,32), null);
...
}).prototype = getMCSymbolPrototype(lib.CTA1a, new cjs.Rectangle(0,0,178,46), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_1.setTransform(169,26,1,1,0,0,0,89,23);
	this.instance_1.alpha = 0;
	this.instance_1._off = true;

	this.instance_2 = new lib.CTA1aTheMoreYouFlyTheMoreWeFlycopy();
	this.instance_2.setTransform(80,3);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(2).to({_off:false},0).to({alpha:1},23,cjs.Ease.quartInOut).wait(53).to({alpha:0},18).to({_off:true},503).wait(1));

	// CTA_1b_Learn_How
	this.instance_3 = new lib.CTA1b();
	this.instance_3.setTransform(169.5,25,1,1,0,0,0,86.5,16);
	this.instance_3.alpha = 0;
	this.instance_3._off = true;

	this.instance_4 = new lib.CTA1bLearnHow();
	this.instance_4.setTransform(83,9);
