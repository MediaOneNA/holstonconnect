...
lib.ssMetadata = [
		{name:"TriAd_1080x1080_atlas_1", frames: [[0,0,1080,1080],[0,1082,1028,160],[1030,1082,393,92],[0,1244,1080,76],[1082,603,209,105],[1082,0,950,601]]}
];
...
}).prototype = getMCSymbolPrototype(lib.CTA3b, new cjs.Rectangle(0,0,393,92), null);
...
}).prototype = getMCSymbolPrototype(lib.CTA3a, new cjs.Rectangle(0,0,1028,160), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_4 = new lib.CTA3a();
	this.instance_4.setTransform(548,138.8,1,1,0,0,0,514,80);
	this.instance_4.alpha = 0;
	this.instance_4._off = true;

	this.instance_5 = new lib.CTA3aWantnewoptions();
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(2).to({_off:false},0).to({y:128,alpha:1},31,cjs.Ease.quartInOut).to({_off:true},566).wait(1));

	// CTA_3b_Fly_Local
	this.instance_6 = new lib.CTA3b();
	this.instance_6.setTransform(540.5,259,1,1,0,0,0,196.5,46);
	this.instance_6.alpha = 0;
	this.instance_6._off = true;

	this.instance_7 = new lib.CTA3bFlyLocal();
	this.instance_7.setTransform(344,204);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(22).to({_off:false},0).to({y:250,alpha:1},25,cjs.Ease.quintInOut).to({_off:true},552).wait(1));
