...
lib.ssMetadata = [
		{name:"TriAd_CTA3_160x600_atlas_1", frames: [[0,721,146,97],[0,820,119,76],[0,962,136,13],[0,602,160,117],[0,898,124,62],[0,0,160,600],[162,0,149,475]]}
];
...
(lib._3aWantnewoptions = function() {
	this.initialize(ss["TriAd_CTA3_160x600_atlas_1"]);
	this.gotoAndStop(0);
...
}).prototype = getMCSymbolPrototype(lib.CTA3B, new cjs.Rectangle(0,0,119,76), null);
...
}).prototype = getMCSymbolPrototype(lib.CTA3A, new cjs.Rectangle(0,0,146,97), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_1.setTransform(82,94.5,1,1,0,0,0,73,48.5);
	...
	this.instance_2.setTransform(82.5,81,1,1,0,0,0,59.5,38);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/TriAd_CTA3_160x600_atlas_1.png", id:"TriAd_CTA3_160x600_atlas_1"}
	],
	preloads: []
};
