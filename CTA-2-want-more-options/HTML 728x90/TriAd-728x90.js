...
lib.ssMetadata = [
		{name:"TriAd_728x90_atlas_1", frames: [[0,0,728,90],[0,266,487,72],[540,92,306,88],[730,0,123,62],[0,184,570,80],[0,92,538,90]]}
];
...
}).prototype = getMCSymbolPrototype(lib.CTA2b, new cjs.Rectangle(0,0,306,88), null);
...
}).prototype = getMCSymbolPrototype(lib.CTA2a, new cjs.Rectangle(0,0,487,72), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_1.setTransform(392.5,47,1,1,0,0,0,243.5,36);
