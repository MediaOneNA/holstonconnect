...
lib.ssMetadata = [
		{name:"TriAd_CTA2_160x600_atlas_1", frames: [[0,721,146,97],[0,820,119,76],[0,962,136,13],[0,602,160,117],[0,898,124,62],[0,0,160,600],[162,0,149,475]]}
];
...
(lib._2aWantmoreoptions = function() {
	this.initialize(ss["TriAd_CTA2_160x600_atlas_1"]);
	this.gotoAndStop(0);
...
}).prototype = getMCSymbolPrototype(lib.CTA2B, new cjs.Rectangle(0,0,119,76), null);
...
}).prototype = getMCSymbolPrototype(lib.CTA2A, new cjs.Rectangle(0,0,146,97), null);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/TriAd_CTA2_160x600_atlas_1.png", id:"TriAd_CTA2_160x600_atlas_1"}
	],
	preloads: []
};
